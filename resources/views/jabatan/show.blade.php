        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Hapus gagal</strong>, Jabatan sudah terpakai
                    <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-hover aligncenter" id="showtable">
                            <thead>
                                    <tr>
                                        <th colspan="5">
                                        <a href="{{route('jabatan.create')}}" type="button" class="btn btn-info btn-sm float-right"><i class="fa-solid fa-plus"></i> Tambah</a>
                                        </th>
                                    </tr>
                                <tr>
                                    <th width="10%">No</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="margin: 10px">
                ...
                <div class="modal-body" id="hapus">
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{route('jabatan.delete')}}" id="form-hapus" >
                                @method('delete')
                                @csrf
...
<script>
    $(function(){
        ...
        $(document).on('click', '.hapusmodal', function(event) {
            ...
            $('#id').val(id);
            $('#des_hapus').html("Apakah Anda yakin ingin menghapus jabatan <b>" +label+"</b> ? ");
