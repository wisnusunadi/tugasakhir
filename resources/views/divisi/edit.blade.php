            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-header bg-success">
                        <h6 class="card-title">Edit Divisi</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="nama" class="col-lg-4 col-md-12 col-form-label labelket">Nama</label>
                            <div class="col-lg-8 col-md-12">
                                <input class="form-control" id="nama" name="nama" value="{{$divisi->nama}}"placeholder="Masukkan Nama Divisi">
                    ...
                    <div class="card-footer">
                        ...
                        <span class="float-right"><button type="submit" id="btnsubmit" class="btn btn-success" >Ubah</button></span>
                    </div>
                </div>
                </form>
            </div>
